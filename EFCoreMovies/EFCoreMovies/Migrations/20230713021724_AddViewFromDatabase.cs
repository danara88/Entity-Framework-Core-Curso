...
{
    /// <inheritdoc />
    public partial class AddViewFromDatabase : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, false, "Animation" },
                    { 3, false, "Comedy" },
                    { 4, false, "Science fiction" },
                    { 5, false, "Drama" }
                });

            migrationBuilder.InsertData(
                table: "Movies",
                columns: new[] { "Id", "OnBillboard", "PosterURL", "ReleaseDate", "Title" },
                values: new object[,]
                {
            ...
            migrationBuilder.InsertData(
                table: "CinemaHalls",
                columns: new[] { "Id", "CinemaHallType", "CinemaId", "Currency", "Price" },
                values: new object[,]
                {
                    { 1, "TwoDimensions", 1, "", 220m },
                    { 2, "ThreeDimensions", 1, "", 320m },
                    { 3, "TwoDimensions", 2, "", 200m },
                    { 4, "ThreeDimensions", 2, "", 290m },
                    { 5, "TwoDimensions", 3, "", 250m },
                    { 6, "ThreeDimensions", 3, "", 330m },
                    { 7, "VIP", 3, "", 450m },
                    { 8, "TwoDimensions", 4, "", 250m }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, 10m, new DateTime(2023, 7, 19, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2023, 7, 12, 0, 0, 0, 0, DateTimeKind.Local) },
                    { 2, 4, 15m, new DateTime(2023, 7, 17, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2023, 7, 12, 0, 0, 0, 0, DateTimeKind.Local) }
                });
