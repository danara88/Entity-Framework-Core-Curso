...
{
    /// <inheritdoc />
    public partial class TestDataSeeding : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "CinemaHalls",
                columns: new[] { "Id", "CinemaHallType", "CinemaId", "Price" },
                values: new object[,]
                {
                    { 1, 1, 1, 220m },
                    { 2, 2, 1, 320m },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, 10m, new DateTime(2023, 6, 17, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2023, 6, 10, 0, 0, 0, 0, DateTimeKind.Local) },
                    { 2, 4, 15m, new DateTime(2023, 6, 15, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2023, 6, 10, 0, 0, 0, 0, DateTimeKind.Local) }
                });
